...
import pt.uninova.s4h.hub.medx.ittm.message.force.ForceTestResponseJson;
import pt.uninova.s4h.hub.medx.ittm.message.login.LoginGsonUtil;
import pt.uninova.s4h.hub.medx.ittm.message.login.LoginRequestJson;
import pt.uninova.s4h.hub.medx.ittm.message.login.LoginResponseJson;
import pt.uninova.s4h.hub.medx.ittm.message.parameters.ParametersGsonUtil;
import pt.uninova.s4h.hub.medx.ittm.message.parameters.ParametersRequestJson;
...
import pt.uninova.s4h.hub.medx.ittm.message.training.TrainingResponseJson;
...
public class IttmApi {
    ...
    private IttmApi(String hostUrl, String machineId) {
        this.hostUrl = hostUrl;
        this.machineId = machineId;
    }

    public static synchronized IttmApi getFirstInstance(String hostUrl, String machineId) {
        if (ittmApi == null) {
            ittmApi = new IttmApi(hostUrl, machineId);
        }
        return ittmApi;
    }
...
//    }
    public ParametersResponseJson downloadTrainingParametersLatest() throws IttmApiException, IttmApiTokenException {
    ...
    public void uploadForceTest(ForceTestRequestJson forceTestRequestJson) throws IttmApiException, IttmApiTokenException {
    ...
    public void uploadTrainingData(TrainingRequestJson trainingRequestJson) throws IttmApiException, IttmApiTokenException {
